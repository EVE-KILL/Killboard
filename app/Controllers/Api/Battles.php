...
class Battles extends Controller
{
    public function __construct(
        protected \EK\Models\Battles $battles,
    ) {
        parent::__construct();
    }
    ...
    {
        $battles = $this->battles->find([], ['hint' => 'battle_id', 'projection' => ['_id' => 0, 'battle_id' => 1]])
    ...
    {
        $battle = $this->battles->findOne(['battle_id' => $id], ['hint' => 'battle_id', 'projection' => ['_id' => 0]])
            ->toArray();
