            ...
            $.each(data, function (i, kill) {
                ...
                if (loop == 1) {
                    h += '<table class="kb-subtable awardbox-top">' +
                        ...
                        '<td><img class="rounded" data-trigger="tooltip" data-delay="0" data-position="e" data-content="' + kill.name + '" src="https://imageserver.eveonline.com/Alliance/' + kill.alliance_id + '_64.png" title="' + kill.name + '" alt="' + kill.name + '" height="64" width="64" /></td>' +
                        ...
                        '<td colspan="2"><a class="kb-shipclass" href="/alliance/'+kill.alliance_id+'" data-trigger="tooltip" data-cssclass="infotip" data-delay="0" data-position="e" data-content="' +
                        '<img class=\'rounded\' src=https://imageserver.eveonline.com/Alliance/' + kill.alliance_id + '_128.png/><br>' +
                        'Alliance: ' + kill.name + '<br>' +
                        'Kills: ' + kill.kills + '<br>' +
